        ...
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center w-full px-8 py-20">
          ...
          <div className="mt-20 w-full flex justify-center">
            <button
              ...
              className="px-16 py-6 rounded-full bg-gradient-to-r from-[#C4A15A] to-[#8C642A] text-[#FFF5E1] font-bold text-xl tracking-[0.2em] uppercase shadow-2xl hover:shadow-[0_12px_40px_rgba(139,110,74,0.4)] hover:-translate-y-1 transition-all active:translate-y-0"
            >
              Consult the Harmony
            </button>
          </div>
